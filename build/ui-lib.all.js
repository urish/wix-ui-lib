...
;jQuery.fn.definePlugin('PluginTemplate', function ($) {
	'use strict';
...
})(jQuery);;jQuery.fn.definePlugin('Checkbox', function($){
	'use strict';
...
;jQuery.fn.definePlugin('ColorPicker', function ($) {
	...
	return {
		init: function(){
			...
			//TODO test this.
			this.siteColors = /*this.isParamConected ? */ true ? (Wix.Settings.getSiteColors() || defaultColors) : defaultColors;
			this.markup();		
		},
		getDefaults: function(){
			return {
...
})(jQuery, window, document);;jQuery.fn.definePlugin('Slider', function ($) {
	'use strict';
